...
''' This script is used to average the models of a 4-way GPU-trained BLNN or HNN. '''
...
for i in range(4):
  ...
  if saved_model['args'].model == 'baseline':
    models.append(BLNN(3, saved_model['args'].hidden_dim, 3, 'Tanh'))
  else:
    models.append(HNN(3, saved_model['args'].hidden_dim, 1, 'Tanh'))
